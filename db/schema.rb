...
ActiveRecord::Schema.define(version: 20170627103501) do
  ...
  create_table "coworkers", force: :cascade do |t|
    ...
    t.index ["customer_id"], name: "index_coworkers_on_customer_id"
  end
  ...
  create_table "gdrives", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "coworkers", "customers"
